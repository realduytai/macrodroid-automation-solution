...
export const config: Options.Testrunner = {
    ...
    capabilities: {
        mobile: { capabilities: {
                'appium:systemPort': 9927,
                'appium:automationName': 'UiAutomator2',
                'appium:deviceName': process.env.ANDROID_DEVICE_NAME,
                platformName: 'android',
                'appium:orientation': 'PORTRAIT',
                'appium:appPackage': process.env.PACKAGE_NAME,
                'appium:appWaitActivity': `${process.env.PACKAGE_NAME}.intro.IntroActivity`,
                'appium:appActivity': `${process.env.PACKAGE_NAME}.LauncherActivity`,
    ...
    dashboard: {
        ...
        capabilities: {
            ...
            'goog:chromeOptions': {
                prefs: {
                    'download.default_directory': exports.globalDownloadDirectory,
                }
            }
        }
    }},
    ...
    //         "platformName": "android",
    //         "appium:automationName": "UiAutomator2",
    //         "appium:app": '/Users/admin/Desktop/Final_Exam_MacroDroid.apk'}],
    maxInstances: 1,
    //
    // ===================
    // Test Configurations
    ...
    logLevel: 'debug', // process.env.DEBUG.toUpperCase() === "Y" ?  'info' : 'error',
    ...
    cucumberOpts: {
        ...
        require: ["./tests/stepDefinitions/hooks.step.ts", "./tests/stepDefinitions/*.ts"],
